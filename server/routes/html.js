...
export default () => {
  ...
  <head>
    ...
    <% if (assets.version) { %><link rel="stylesheet" type="text/css" href="//cdn.auth0.com/extensions/temp/auth0-authz.ui.<%= assets.version %>.css"><% } %>
  </head>
  <body>
    <div id="app"></div>
    ...
    <% if (assets.version) { %>
    <script type="text/javascript" src="//cdn.auth0.com/extensions/temp/auth0-authz.ui.vendors.<%= assets.version %>.js"></script>
    <script type="text/javascript" src="//cdn.auth0.com/extensions/temp/auth0-authz.ui.<%= assets.version %>.js"></script>
    <% } %>
  </body>
  </html>
  `;
