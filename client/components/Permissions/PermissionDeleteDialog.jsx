...
export default class PermissionDeleteDialog extends Component {
  ...
  render() {
    ...
    return (
      <Confirm title={ title } show={ permission.requesting && permission.isDelete } loading={ permission.loading }
        onCancel={ this.clear } onConfirm={ this.confirm }>
        <LoadingPanel show={ permission.loading } spinnerStyle={{ height: '40px', width: '40px' }}
